#ifndef PHYSICS_HARDWARE_STAGECOMPONENT_H
#define PHYSICS_HARDWARE_STAGECOMPONENT_H
#pragma once
...
namespace Physics {
	namespace Hardware {
		...
		public:
			StageComponent(CoordTransform3D compToStage = CoordTransform3D(), Mass mass_comp = Mass(), InertiaTensor CoMInertia_comp = InertiaTensor()) :
